...
class Medoo
{
    ...
    /**
     * [inner_conjunct description]
     * @param  [type] $data             [description]
     * @param  [type] $conjunctor       [description]
     * @param  [type] $outer_conjunctor [description]
     * @return [type]                   [description]
     */
